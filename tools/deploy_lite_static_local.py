...
FILES = [
    ...
    ("panel/routes/center.py", "panel/routes/center.py"),
    ("panel/routes/hyperv.py", "panel/routes/hyperv.py"),
    ("panel/routes/ips.py", "panel/routes/ips.py"),
    ("panel/routes/monitor.py", "panel/routes/monitor.py"),
    ("panel/routes/pve.py", "panel/routes/pve.py"),
    ...
    ("panel/services/fast_speed.py", "panel/services/fast_speed.py"),
    ("panel/services/hyperv_manager.py", "panel/services/hyperv_manager.py"),
    ("panel/services/inbound_instance_manager.py", "panel/services/inbound_instance_manager.py"),
    ("panel/services/instance_manager.py", "panel/services/instance_manager.py"),
    ("panel/services/limit_manager.py", "panel/services/limit_manager.py"),
    ("panel/services/pve_manager.py", "panel/services/pve_manager.py"),
    ...
    ("panel/services/singbox_monitor.py", "panel/services/singbox_monitor.py"),
    ("panel/services/system_info.py", "panel/services/system_info.py"),
...
def main():
    ...
    try:
        ...
        compile_targets = [
            ...
            posixpath.join(app_dir, "panel", "routes", "center.py"),
            posixpath.join(app_dir, "panel", "routes", "servers.py"),
            posixpath.join(app_dir, "panel", "routes", "users.py"),
        ]
